 ...
 * @Date 2018/11/1
 **/
public class MonsterKing extends Hero {
    public final static int EXP = 10000;
    private final static String NAME = "兽王";//你的名字
    ...
    public MonsterKing() {
        ...
        //自己搞两个技能
        Skill givePoison = new GivePoison();
        Skill giveSand = new GiveSand();
        super.addSkill(givePoison);
        super.addSkill(giveSand);
    }
}
