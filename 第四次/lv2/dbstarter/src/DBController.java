...
public class DBController {
    ...
    DBController(DBTool dbTool) throws SQLException {
        this.dbTool = dbTool;
    }
    ...
    void Dealer() throws SQLException {
        System.out.println("--------------------------------");
        //录入功能
        dbTool.insertDepart(87, "部门A", 10000000);
        dbTool.insertDepart(321, "部门B", 321123);
        dbTool.insertDepart(666, "部门C", 666666);
        ...
        dbTool.insertGoods(222, "ABC洗衣液", 22.4, 10.0);
        dbTool.insertGoods(333, "苏打水", 4, 3);
        dbTool.insertGoods(444, "ABC洗衣粉", 20, 10.5);
        dbTool.insertGoods(555, "台灯", 40, 30);
        dbTool.insertGoods(577, "灯泡", 30, 10);
        ...
        //遍历
        System.out.println("旧表");
        dbTool.order("employee","id",true);
        System.out.println("--------------------------------");
        //删除
        dbTool.delete(201777, "employee");
        System.out.println("新表");
        dbTool.order("employee","id",true);
        System.out.println("--------------------------------");
        //查询
        dbTool.search("李四", "employee");
        dbTool.search("U盘", "goods");
        dbTool.search("香蕉","goods");
        System.out.println("--------------------------------");
        //修改
        dbTool.change("goods", 555, "水壶", "name");
        System.out.println("--------------------------------");
        //价格降序/升序排列
        dbTool.order("goods", "selling_price", true);
        System.out.println("--------------------------------");
        dbTool.order("goods", "selling_price", false);
        System.out.println("--------------------------------");
        //模糊查询
        dbTool.search2("ABC", "goods");
        dbTool.search2("灯", "goods");
    }
